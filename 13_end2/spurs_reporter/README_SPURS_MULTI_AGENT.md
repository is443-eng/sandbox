...
- See **`README_spurs_dependencies.md`** and **`../requirements.txt`** (**pandas**, **tabulate**, **requests**, **nba_api**).
...
|-----------|----------------------|
| Multi-agent orchestration | `13_end2/spurs_reporter/lab_spurs_multi_agent.py` |
| RAG / refresh CLI | `13_end2/spurs_reporter/spurs_season_rag.py` |
| Store + SQL | `13_end2/spurs_reporter/spurs_season_store.py` |
| Tool stats / consistency | `13_end2/spurs_reporter/spurs_stats.py` |
| Ollama helpers | `13_end2/spurs_reporter/functions.py` |
| Dependencies | `13_end2/requirements.txt` |
